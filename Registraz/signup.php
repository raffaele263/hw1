    ...
    <body>
        ...
        <section class="main_right">
            ...
            <form name='signup' method='post' enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="Numero Fisso">
                    <label for='Numero Fisso'>Email</label>
                    <input type='text' name='Numero Fisso' <?php if(isset($_POST["Numero Fisso"])){echo "value=".$_POST["Numero Fisso"];} ?>>
