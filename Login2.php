<?php
    ...
    if (!empty($_POST["NomeUtente"]) && !empty($_POST["password"]) )
    {
        ...
        $query = "SELECT * FROM users WHERE username = '".$NomeUtente."'";
    ...
    <body>
        ...
        <div id="Login">
            ...
            <input class="inputlogin" type='password' name='password' id="PasswordLogin" <?php if(isset($_POST["password"])){echo "value=".$_POST["password"];} ?> > 
             <input id="ButtonLogin" type='submit'  name="Login" value="Accedi">
            <a id="ButtonRegistrazione"href="signup.php">Fai Clic qui per Registrarti</a>
            </form>
